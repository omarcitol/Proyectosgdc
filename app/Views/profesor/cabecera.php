...
.notification-badge{
    ...
    <div class="container-fluid p-0 d-flex h-100">
        <div id="bdSidebar" class="d-flex flex-column flex-shrink-0 p-3 bg-success text-white offcanvas-md offcanvas-start" style="width: 280px;">
            ...
            <h5><i class="fa-solid fa-user-tie" style="font-size: 28px;"></i> Bienvenido Profesor</h5>
            </a>
            ...
            <ul class="mynav nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item mb-1">
                    <a href="cargarnotas" class="">
                        <i class="fa-solid fa-chart-simple"></i>
                        Cargar Notas
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a href="configuracion2" class="">
                        <i class="fa-solid fa-user"></i>
                        Configuraciones
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a href="crearcurso" class="">
                        <i class="fa-solid fa-chart-simple"></i>
                        Crear Curso 
                    </a>
                </li>
